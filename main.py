...
EXAMPLE_PREDICTOR_VARIABLE_NAMES = [
    ...
    'B205WC000.AM01',# SUPPLY TEMPERATURE CHILLED WATER
    'B201AH163.AC21',# COOLER VALVE
    'B205WC001.AM01',# SUPPLY TEMPERATURE CHILLED WATER
    'B205WC003.AM01',# SUPPLY TEMP. CHILLED WATER BP201/202/206
    'B201AH162.AC21',# COOLER VALVE
    'B201RC031.RA24',# DDC TEMPERATURE COOLING OUTPUT
    'B201RC031.RA24',# DDC TEMPERATURE COOLING OUTPUT
    #above 0.4
    'B205WC000.AM71',# VOLUME CHILLED WATER BP201/202/206
    'B201AH164.AC21',# COOLER VALVE
    'B205WC000.DM90',# MAX. TEMP. CHILLED WATER
    'B201AH603.AM81',# DIFFERENCE-PRESSURE OUTSIDE-AIR FILTER
    'B201AH662.VH01',# SETPOINT RETURN-AIR HUMIDITY MAX
    'B201FC266_2.VT03_2',# ACTIVE SETPOINT TEMP. 201.C.285
    'B201FC266_2.VT02_1',# ACTIVE SP. TEMP. COOLING 201.C.285
    'B205WC001.AM71',# TOTAL VOLUME CHILLED WATER
    'B205WC002.RA001',# SPEED CHILLED WATER PUMP
    'B201RC136.VQ21',# SETPOINT AIR QUALITY
    'B201AH602.VH01',# SETPOINT RETURN-AIR HUMIDITY MAX
