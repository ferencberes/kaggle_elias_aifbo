...
if __name__ == "__main__":
    ...
    prepared_data_dir = f"{OUTPUTS_DIR}/useCoolerValves_{use_cooler_valves}_useActiveSetpoints_{use_active_setpoints}_useCO2Concentrations_{use_co2_concentrations}"
