...
EXAMPLE_PREDICTOR_VARIABLE_NAMES = [
    ...
    #'B205WC030.AM52_1',# CONDENSER FLOW SWITCH STATUS
    #'B205WC100.PA72',# VOLUME FEEDING PROCESS CHILLED WATER
    #'B205HW020.VT01',# SETP. OUTLET-TEMP. BOILER
    #'B205WC010.AC62',# SPEED COOLING WATER PUMP 2
    #'B205HW020.AM61_1',# MODULATION DEGREE
    #'B205WC030.AM51_3',# CHILLER STATE
    #'B205WC030.AC62',# SPEED COOLING WATER PUMP 2
    #'B205WC001.VT01',# REQUESTED TEMPERATURE SETPOINT SUPPLY
    #'B205WC010.VT01_1',# CHILLED WATER SETPOINT
    #'B205WC030.VT01_1',# CHILLED WATER SETPOINT
    #'B205WC000.VT01',# REQUESTED TEMPERATURE SETPOINT SUPPLY
    #'B205WC030.AC61',# SPEED COOLING WATER PUMP 1
